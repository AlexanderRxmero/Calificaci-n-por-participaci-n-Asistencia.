...
namespace AppLoginMVC
{
    public partial class FrmLogin : Form
    {
        ...
        private void InitComponentsManual()
        {
            ...
            // Campo Usuario
            var lblUsr = new Label { Text = "Usuario:", Location = new Point(40, 168), Size = new Size(80, 22) };
            txtUsuario = new TextBox { Location = new Point(125, 165), Size = new Size(210, 26) };

            // Campo Contraseña 
            var lblPass = new Label { Text = "Contraseña:", Location = new Point(40, 208), Size = new Size(80, 22) };
            ...
            {
                int nivel = Modelo.PasswordUtils.CalcularFortaleza(txtContrasena.Text);
        ...
        {
            this.Text = "Login — Sistema de Acceso";
